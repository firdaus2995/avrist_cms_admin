...
export type GetListCharactersQueryVariables = Exact<{
  page?: InputMaybe<Scalars['Int']>;
}>;
...
export type GetDetailCharacterQueryVariables = Exact<{
  id: Scalars['ID'];
}>;
