...
export default function GroupMenuEdit () {
  ...
  // RTK CREATE MENU
  const [editGroupMenu, { isLoading }] = useUpdateGroupMenuMutation();
  ...
  useEffect(() => {
    if (data) {
      ...
      defaultValues.name = data?.menuGroupDetail?.name;
