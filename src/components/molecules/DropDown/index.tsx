...
const DropDown = ({
  ...
  return (
    <div className="w-full" ref={componentRef}>
      <button onClick={() => {
        setOpen(!open); 
      }} tabIndex={0} className="flex flex-row justify-between items-center p-3 w-full border-[1px] border-neutral-300 rounded-3xl bg-transparent box-border text-left text-sm focus:border-purple-600">
        {selected}
